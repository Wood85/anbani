      ...
      <div className={styles.content}>
        <div className={styles.list}>
          <div className={styles.item}>
            ...
            <p className={styles.subtitleH4}>{t('text1.subtitle')}</p>
          ...
          <div className={styles.item}>
            ...
            <p className={styles.subtitleH4}>{t('text2.subtitle')}</p>
          ...
          <div className={styles.item}>
            ...
            <p className={styles.subtitleH4}>{t('text3.subtitle')}</p>
          ...
          <div className={styles.item}>
            ...
            <p className={styles.subtitleH4}>{t('text4.subtitle')}</p>
